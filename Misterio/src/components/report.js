...
const Report = (gameName, player_id) => {

  let list_c = JSON.parse(localStorage.getItem('list_report' + gameName + player_id))
  let list_s = JSON.parse(localStorage.getItem('list_solution' + gameName + player_id))
  ...
  if(list_s === null){
    ...
    localStorage.setItem('list_solution' + gameName + player_id, JSON.stringify(list_s));
  }
  ...
  function Counter(i) {
    ...
    if(list_c === null){
      ...
      localStorage.setItem('list_report' + gameName + player_id, JSON.stringify(list_c));
    }
